...
var require_bundle = __commonJS({
  "node_modules/@editorjs/marker/dist/bundle.js"(exports, module) {
    !function(t, e) {
      ...
      return function(t) {
        ...
        (t.exports = n(2)(false)).push([t.i, ".cdx-marker {\n  background: rgba(245,235,111,0.29);\n  padding: 3px 0;\n}", ""]);
      }, function(t, e) {
        ...
        function p(t2, e2) {
          for (var n2 = 0; n2 < t2.length; n2++) {
            ...
            if (o2) {
              ...
              var s2 = [];
              for (a2 = 0; a2 < r2.parts.length; a2++) s2.push(g(r2.parts[a2], e2));
        ...
        function h(t2, e2) {
          ...
          var r2 = f[f.length - 1];
          if ("top" === t2.insertAt) r2 ? r2.nextSibling ? n2.insertBefore(e2, r2.nextSibling) : n2.appendChild(e2) : n2.insertBefore(e2, n2.firstChild), f.push(e2);
        ...
        function g(t2, e2) {
          ...
          if (e2.singleton) {
            var a2 = c++;
            n2 = u || (u = b(e2)), r2 = x.bind(null, n2, a2, false), o2 = x.bind(null, n2, a2, true);
        ...
        function x(t2, e2, n2, r2) {
          var o2 = n2 ? "" : r2.css;
          if (t2.styleSheet) t2.styleSheet.cssText = w(e2, o2);
          else {
        ...
        var i = function() {
          function t2(e2) {
            ...
            }(this, t2), this.api = n2, this.button = null, this.tag = "MARK", this.iconClasses = { base: this.api.styles.inlineToolButton, active: this.api.styles.inlineToolButtonActive };
          }
...
//# sourceMappingURL=@editorjs_marker.js.map
