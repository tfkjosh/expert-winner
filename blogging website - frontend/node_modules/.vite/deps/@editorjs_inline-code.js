      ...
      return function(t) {
        ...
        function p(t2, e2) {
          for (var n2 = 0; n2 < t2.length; n2++) {
            ...
            if (o2) {
              o2.refs++;
              for (var s2 = 0; s2 < o2.parts.length; s2++) o2.parts[s2](r2.parts[s2]);
              for (; s2 < r2.parts.length; s2++) o2.parts.push(g(r2.parts[s2], e2));
            } else {
              var a2 = [];
              for (s2 = 0; s2 < r2.parts.length; s2++) a2.push(g(r2.parts[s2], e2));
        ...
        t.exports = function(t2, e2) {
          ...
          return p(n2, e2), function(t3) {
            ...
            for (o2 = 0; o2 < r2.length; o2++) {
              var a2;
              if (0 === (a2 = r2[o2]).refs) {
                for (var u2 = 0; u2 < a2.parts.length; u2++) a2.parts[u2]();
                delete i[a2.id];
              }
            }
          };
