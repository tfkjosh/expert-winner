...
var et = ((s) => (s.VERBOSE = "VERBOSE", s.INFO = "INFO", s.WARN = "WARN", s.ERROR = "ERROR", s))(et || {});
var B = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
var d = class _d {
  ...
  static findAllInputs(e) {
    return it(e.querySelectorAll(_d.allInputsSelector)).reduce((t, o) => _d.isNativeInput(o) || _d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ..._d.getDeepestBlockElements(o)], []);
  }
  /**
...
var S = class _S {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }, this.mutableListenerIds = [], new.target === _S)
...
`);
      ...
      function x(b, g) {
        ...
        if (g.singleton) {
          var H = h++;
          E = u || (u = A(g)), C = R.bind(null, E, H, false), O = R.bind(null, E, H, true);
        } else
...
var ue = class _ue {
   ...
   */
  render(e) {
    this.wrapper = d.make("div", _ue.CSS.wrapper);
    const t = d.make("div", _ue.CSS.icon, {
      innerHTML: Lo
    });
    this.input = d.make("input", _ue.CSS.input, {
      placeholder: e
...
var be = ((s) => (s.Opened = "toolbox-opened", s.Closed = "toolbox-closed", s.BlockAdded = "toolbox-block-added", s))(be || {});
...
var me = ((s) => (s.Shortcut = "shortcut", s.Toolbox = "toolbox", s.EnabledInlineTools = "inlineToolbar", s.EnabledBlockTunes = "tunes", s.Config = "config", s))(me || {});
var kt = ((s) => (s.Shortcut = "shortcut", s.SanitizeConfig = "sanitize", s))(kt || {});
...
var je = ((s) => (s.IsInline = "isInline", s.Title = "title", s))(je || {});
var vt = ((s) => (s.IsTune = "isTune", s))(vt || {});
var Ue = class {
  /**
   * @class
...
var Uo = class extends S {
  ...
  addConversionToggler() {
    ...
    }), ee() === false && this.tooltip.onHover(this.nodes.conversionToggler, $.ui(X.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
...
var xt = class extends S {
  ...
  getFilesConfig(s) {
    ...
    !t && !o || (t && !Array.isArray(t) && (T(`«extensions» property of the onDrop config for «${s.name}» Tool should be an array`), t = []), o && !Array.isArray(o) && (T(`«mimeTypes» property of the onDrop config for «${s.name}» Tool should be an array`), o = []), o && (o = o.filter((i) => Dt(i) ? true : (T(`MIME type value «${i}» for the «${s.name}» Tool is not a valid MIME type`, "warn"), false))), this.toolsFiles[s.name] = {
      extensions: t || [],
      mimeTypes: o || []
    });
  }
...
var pe = class _pe extends S {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d.make("div", _pe.CSS.overlay, {}), i = d.make("div", _pe.CSS.overlayContainer, {}), n = d.make("div", _pe.CSS.rect, {});
...
var Jo = class extends S {
  ...
  async insertBlock(e) {
    ...
    if (t.available.has(i))
      ...
      u.stretched = true, T(`Tool «${i}» is not found. Check 'tools' property at your initial Editor.js config.`, "warn");
    }
  }
};
var Qo = class extends S {
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(b)))), " */")), y.styleSheet)
      ...
      function A(y, x) {
        ...
        if (x.singleton) {
          var b = N++;
          w = _ || (_ = h(x)), M = p.bind(null, w, b, false), R = p.bind(null, w, b, true);
        } else
